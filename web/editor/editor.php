...
<html>
    ...
    <head>
        ...
        <!-- <script type="text/javascript" src="./lib/sets/basic/basic.js"></script> --> <!-- yaobin: remove this set -->
        <!-- <script type="text/javascript" src="./lib/sets/experimental/experimental.js"></script> --> <!-- yaobin: remove this set -->
        <!-- <script type="text/javascript" src="./lib/sets/network/network.js"></script> --> <!-- yaobin: remove this set -->
        <!-- <script type="text/javascript" src="./lib/sets/secondary/secondary.js"></script> --> <!-- yaobin: remove this set -->
        <script type="text/javascript" src="./lib/sets/workflow/workflow.js"></script>
        <!-- <script type="text/javascript" src="./lib/sets/statemachine/statemachine.js"></script> --> <!-- yaobin: remove this set -->
